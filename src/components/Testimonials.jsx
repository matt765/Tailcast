...
export const Testimonials = () => (
  <section className="w-full flex justify-center pt-16 mb-16 lg:mb-32 bg-bgDark2 relative">
    ...
    <div className="flex flex-col w-full lg:w-[1150px] justify-center">
      ...
      >
        <div className="block-subtitle text-center mb-6">
          Testimonials
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-5 xl:gap-10 px-6 xl:px-0 items-center">
          {testimonialsData.map((testimonial, index) => (
            <div
              className="w-11/12 sm:w-4/5 md:w-[560px] lg:w-1/3 custom-border-gray-darker rounded-xl bg-bgDark3 flex flex-col px-6 py-4"
