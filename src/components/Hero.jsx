...
export const Hero = () => {
  return (
    <section className="w-screen  flex justify-center items-center dark:bg-customDarkBg1 bg-white mb-64 hero-bg-gradient">
      <div className="w-2/5 flex flex-col justify-center items-center pt-16 text-center">
        ...
        <div className="flex mt-14 mb-40">
          <div className="w-60 h-14 rounded-xl font-bold bg-customPrimary text-white mr-10  flex justify-center items-center hero-button-gradient">
            Get Started
          </div>
          <div className="w-60 h-14 rounded-xl font-bold text-white border border-solid  flex justify-center items-center cursor-pointer bg-customDarkBg2 custom-border-gray">
            Live demo
          </div>
        </div>
        <div className="relative w-screen flex justify-center ">
          <img
            ...
            alt="123"
            width="1200px"
            className="absolute z-50 rounded-xl custom-border-purple hero-dashboard-border-gradient"
          />
